  ...
  useEffect(() => {
    if (isEditMode && editingJobSheet) {
      const formData = {
        ...
        productTypeId: editingJobSheet.productType?.id?.toString() || "",
        brandId: editingJobSheet.brand?.id?.toString() || "",
        modelId: editingJobSheet.model?.id?.toString() || "",
      ...
      form.reset(formData);
      setSelectedProductType(editingJobSheet.productType?.id?.toString() || "");
      setSelectedBrand(editingJobSheet.brand?.id?.toString() || "");
    } else {
      form.reset({
        customerName: "",
        phone: "",
