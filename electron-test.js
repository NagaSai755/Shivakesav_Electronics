...
function createWindow() {
  console.log('Creating SHIVAKESHAVA ELECTRONICS test window...');
  ...
  mainWindow = new BrowserWindow({
    ...
    title: 'SHIVAKESHAVA ELECTRONICS - Test Window',
    show: true,
  ...
  const testHTML = `
    <html>
      <head>
        <title>SHIVAKESHAVA ELECTRONICS Test</title>
        <style>
          body { 
  ...
  console.log('✅ SHIVAKESHAVA ELECTRONICS test window created successfully!');
...
app.whenReady().then(() => {
  console.log('🚀 Electron ready - creating SHIVAKESHAVA ELECTRONICS test window');
  createWindow();
});
